...
namespace Reportes
{
    public partial class R_Cuenta_Clie_Usu : Form
    {
        Cpersona oPersona;
        ...
        private void R_Cuenta_Load(object sender, EventArgs e)
        {

            Microsoft.Reporting.WinForms.ReportParameter alta = new Microsoft.Reporting.WinForms.ReportParameter("Altas", "true");
            ...
            reportViewer1.LocalReport.SetParameters(alta);
